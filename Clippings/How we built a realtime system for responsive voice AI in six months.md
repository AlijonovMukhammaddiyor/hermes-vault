...
Delivering this experience at scale required a new system architecture optimized for low latency. <mark style="background:#fff88f">Unlike typical request-response inference, our system streams incoming audio into the voice model and outbound speech back to the user, while handling delegation on a separate asynchronous path</mark>. Over the last six months, we reworked model inference, context management, and media transport to keep speech flowing smoothly from end to end.
...
![Diagram showing GPT-Live's realtime frontend voice model, asynchronous delegation to a backend reasoning model, tool use, and bidirectional audio with the user.](https://images.ctfassets.net/kftzwdyauwt9/5ucWz9OnRduVAhjcryxTBr/f0d287b783bab793e0cefae46c6350fb/gpt-live-system-architecture-dark-desktop.svg?w=3840&q=80)
...
<audio src="https://cdn.openai.com/ctf-cdn/bidi/live-search-mixed.wav"></audio>
